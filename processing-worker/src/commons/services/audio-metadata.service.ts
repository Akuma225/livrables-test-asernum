...
export class AudioMetadataService {
  async extract(document: MinimalDocumentInfo, buffer: Buffer): Promise<Record<string, any>> {
    ...
    return {
      ...
      // tags "utiles" (si disponibles)
      title: parsed.common.title ?? null,
      artist: parsed.common.artist ?? null,
      album: parsed.common.album ?? null,
      year: typeof parsed.common.year === 'number' ? parsed.common.year : null,
      trackNo: typeof parsed.common.track?.no === 'number' ? parsed.common.track.no : null,
      genre: Array.isArray(parsed.common.genre) ? parsed.common.genre : null,
    };
  }
}
